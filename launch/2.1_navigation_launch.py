...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value='/home/michele/tesi_code/src/myCode/maps/maze_map.yaml',#maze_map
    ...
    rl_launch_path = os.path.join(get_package_share_directory("myCode"), 'launch', '1_robot_localizer.launch.py')
    ...
    bringup_cmd_group = GroupAction([
        ...
        #------------------------------------------------------------
        # localization AMCL (slam 3.3)
        #------------------------------------------------------------
        # IncludeLaunchDescription(
        #     PythonLaunchDescriptionSource(os.path.join(launch_dir, '3.1_slam_launch.py')),
        ...
        # IncludeLaunchDescription(
        #     PythonLaunchDescriptionSource(os.path.join(launch_dir, '3.3_slam_launch.py')),
        #     # condition=IfCondition(slam),
        #     launch_arguments={'namespace': namespace,
        #                       'use_sim_time': use_sim_time,
        #                       'autostart': autostart,
