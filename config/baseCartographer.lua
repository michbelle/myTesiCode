...
-- has to be a copy of the used for mapping -> SLAM used ??????
options = {
...
TRAJECTORY_BUILDER_2D.max_range = 40  -- the maximum scanning range of the lidar
...
-- POSE_GRAPH.optimize_every_n_nodes = 2 --permette saving pbstream?
return options