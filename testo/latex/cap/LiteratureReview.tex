...
\begin{itemize}
	...
	\remove{\item \textbf{rqt\_console}: A plugin for rqt that visualizes the logs generated by the ROS. è solo un plugin del precedente }
...
\begin{itemize}
	...
	\end{figure}\\
	\alert{In the future, this is going to be update to use the  \textbf{rmf\_site}\footnote{\href{https://github.com/open-rmf/rmf\_site}{https://github.com/open-rmf/rmf\_site}}}
