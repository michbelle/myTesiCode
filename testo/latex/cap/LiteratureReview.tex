...
\begin{itemize}
	\item An communication system named middleware or plumbing. This allow the Nodes to share information between each other with an anonymous publish/subscribe pattern allowing fault isolation, separation of concerns and clear interfaces and a synchronous system RPC-style communication between services.
