...
\begin{itemize}
	...
	\end{figure}\\
	Nodes can also be composed within the same process using the \textbf{Composition} feature, which improves performance by bypassing middleware overhead\cite{macenski2023impactros2node}. 
...
\begin{itemize}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.78\linewidth]{img/bt_nav2_neg.humble.png}
