...
\begin{itemize}
	...
	\item \textbf{Open-rmf}\footnote{\href{https://www.open-rmf.org/}{https://www.open-rmf.org/}} is a free, open source, modular software system that enables sharing and interoperability between multiple fleets of robots and physical infrastructure, like doors, elevators and building management systems. 
...
\end{figure}
\\
and the tools that provide are:
\begin{itemize}
	\item \textbf{Transitive Robotics}
\end{itemize}
