...
\alert{
In this chapter we modified the code to control the robot based on ROS 1 to ROS 2.}
\section{how is made}
\alert{
the robot is a 2WD rover based on a NUC connected to a laser scanner A3 and an arduino that throutght a serial control control the robot and obtain the data from the IMU.\\the robot is the following one:\\
}
\begin{figure}[h]
	\centering
...
\section{create a simulated robot}
